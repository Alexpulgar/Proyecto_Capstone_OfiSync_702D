      ...
      {edificioEncontrado && (
        <div className="agregar-form" style={{ marginTop: "20px" }}>
          ...
          <div className="form-group">
            ...
            <input
              type="text"
              value={edificioEncontrado.pisos_totales}
              disabled
            />
          </div>
          <div className="form-group">
            ...
            <input
              type="text"
              value={edificioEncontrado.area_bruta_por_piso}
              disabled
            />
          </div>
          <div className="form-group span-2">
            ...
            <input
              type="text"
              value={edificioEncontrado.area_comun_pct}
              disabled
            />
          </div>
