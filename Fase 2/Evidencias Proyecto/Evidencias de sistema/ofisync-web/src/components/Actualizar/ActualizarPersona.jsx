    ...
    <div className="contenedorAgregar">
      ...
      <div className="agregar-form">
        ...
        <div className="form-group span-2">
          {" "}
          <label htmlFor="rut_busqueda">
            Buscar por RUT (Formato: 12345678-9)
          </label>{" "}
          <input
            id="rut_busqueda"
            type="text"
      ...
      {mensaje && (
        <p
          className={`mensaje-feedback ${
            mensaje.startsWith("Error") ? "error" : "info"
          }`}
        >
          {mensaje}{" "}
        </p>
      ...
      {personaEncontrada && (
        <form
          ...
          className="agregar-form form-seccion-actualizar"
        >
          {" "}
          <div className="form-group span-full">
            {" "}
            <h3 className="form-subtitulo">Datos de la Persona</h3>{" "}
            <p className="form-subtitulo-desc">
              Solo se puede modificar el correo y el teléfono.
            </p>{" "}
          </div>{" "}
          <div className="form-group">
            <label>RUT</label>{" "}
