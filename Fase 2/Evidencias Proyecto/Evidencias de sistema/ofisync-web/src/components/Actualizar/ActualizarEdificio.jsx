...
function ActualizarEdificio() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      form.area_comun_pct !== null &&
      (form.area_comun_pct < 0 || form.area_comun_pct > 100)
    ) {
        ...
        <form onSubmit={handleSubmit} className="agregar-form">
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="number"
              name="pisos_totales"
              value={form.pisos_totales}
              onChange={handleChange}
            />{" "}
          </div>{" "}
          <div className="form-group">
            {" "}
            <label htmlFor="area_bruta_por_piso">
              Área bruta por piso (m²)
            </label>{" "}
            <input
              id="area_bruta_por_piso"
              type="number"
              name="area_bruta_por_piso"
              value={form.area_bruta_por_piso}
              onChange={handleChange}
            />{" "}
          </div>{" "}
          <div className="form-group span-2">
