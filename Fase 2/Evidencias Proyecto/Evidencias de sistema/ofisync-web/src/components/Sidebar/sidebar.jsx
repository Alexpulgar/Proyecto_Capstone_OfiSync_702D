...
const allLinks = [
  { path: "/inicio", label: "Inicio", icon: "/img/icons/home.svg", allowedRoles: ['admin'] },
  { path: "/administracion", label: "Administración", icon: "/img/icons/admin.svg", allowedRoles: ['admin'] }, 
